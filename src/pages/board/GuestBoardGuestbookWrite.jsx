...
const GuestbookGrayBar = styled.div`
  ...
  align-items: center;
`;
const GuestbookWrite = styled.div`
  margin-left: 20vw;
  margin-top: 0.3vw;
  width: 5vw;
  font-size: 12px;
...
const GuestBoardGuestbookWrite = () => {
  ...
  return (
    <BookTheme>
      ...
      <GuestbookSide>
        ...
        <GuestbookGrayBar />
        <Link
          to="/guest-board-guestbookwrite"
          style={{ textDecoration: "none" }}
        >
          <GuestbookWrite>방명록 쓰기</GuestbookWrite>
        </Link>
        <GuestbookContainer>
          <GuestbookArea>
            <GuestbookHead>
...
export default GuestBoardGuestbookWrite;
