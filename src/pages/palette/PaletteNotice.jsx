...
const NoticePage = () => {
  ...
  const NoticeList = async () => {
    try {
      const exText = [
        { classNo: 8, title: "개인정보 처리방침 개정 안내 (24년 7월 1일 시행)", join: "2024-07-02" },
        { classNo: 7, title: "Front-end, Back-end 개발", join: "2024-07-01" },
        { classNo: 6, title: "백엔드 너무 어렵고 눈물이 나..", join: "2024-06-30" },
        { classNo: 5, title: "개인정보 처리방침 개정 안내 (24년 6월 26일 시행)", join: "2024-06-26" },
        { classNo: 4, title: "플로우 차트, 스토리 보드 작성", join: "2024-06-25" },
        { classNo: 3, title: "사이트 점검 안내", join: "2024-06-16" },
        { classNo: 2, title: "DB Table 구성", join: "2024-06-13" },
